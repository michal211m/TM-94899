...
* **Wniosek:** Docker zawiera odchudzoną wersję Linuxa, na której instalowane jest dane oprogramowanie. Rozwiązuje to problem z kompatybilnością na różnych urządzeniach.
...
* **Wniosek:** Analiza statyczna pozwoliła zidentyfikować wykorzystywane przez aplikację uprawnienia, biblioteki zewnętrzne oraz potencjalne słabe punkty związane z konfiguracją bezpieczeństwa.

### 🔹 BLOK 3-4: Fundamenty Skryptowania (Python for QA)
Budowa logiki testowej w języku Python.
* **Co zrobiono:** Poznanie podstawowych struktur danych (listy, słowniki) oraz funkcji w języku Python. Uczenie się tworzenia prostych skryptów do automatyzacji zadań.
...
* **Co zrobiono:** Poznanie podstawowych selektorów (ID, XPath) oraz akcji na urządzeniu (klikanie, wpisywanie tekstu).
